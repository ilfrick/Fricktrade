...
_DESCRIPTIONS = {
    ...
    "risk.small_account.enabled": "Enable small-account trade guardrails.",
    "risk.small_account.max_equity": "Max equity for small-account rules to apply.",
    "risk.small_account.min_equity": "Block trading if equity falls below this.",
    "risk.small_account.min_cash": "Block trading if cash falls below this.",
    "risk.small_account.min_notional": "Minimum notional required for buys on small accounts.",
    "risk.small_account.cooldown_multiplier": "Cooldown multiplier when small-account rules apply.",
    ...
    "orchestrator.ml.pretrain.provider": "Pretrain data provider (yfinance or alpaca).",
    "orchestrator.ml.pretrain.alpaca_api_key": "Alpaca API key for pretraining (env-supported).",
    "orchestrator.ml.pretrain.alpaca_api_secret": "Alpaca API secret for pretraining (env-supported).",
    "orchestrator.ml.pretrain.lookback_days": "Pretrain lookback days.",
    "orchestrator.ml.pretrain.interval": "Pretrain data interval.",
    "orchestrator.ml.pretrain.window_days": "Rolling window size in days for intraday pretrain.",
    "orchestrator.ml.pretrain.coverage_days": "Total historical coverage in days for pretrain.",
    "orchestrator.ml.pretrain.step_days": "Step size in days between pretrain windows.",
